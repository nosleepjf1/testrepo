...
if(lastRow) {
    ...
    for(var i = 1; i <= 9; i++){
        ...
        arrayOfXs.push(name);
//use the id of 'name' to find out the block number
    //get the numbers of the rest of the block in order to find out which number can still be used
    //add that number to the element
    //its possible to have more than one error on the same block so i have to code for that
    //save these positions somewhere so that later i can save them as the correct markers
...
FillRestOfBoard(block2num7, "block2num7", row2);
FillRestOfBoard(block2num8, "block2num8", row2);
FillRestOfBoard(block2num9, "block2num9", row2);
FillRestOfBoard(block3num7, "block3num7", row2);
FillRestOfBoard(block3num8, "block3num8", row2);
FillRestOfBoard(block3num9, "block3num9", row2);
...
FillRestOfBoard(block4num1, "block4num1", row2);
FillRestOfBoard(block4num2, "block4num2", row2);
FillRestOfBoard(block4num3, "block4num3", row2);
FillRestOfBoard(block5num1, "block5num1", row2);
FillRestOfBoard(block5num2, "block5num2", row2);
FillRestOfBoard(block5num3, "block5num3", row2);
FillRestOfBoard(block6num1, "block6num1", row2);
FillRestOfBoard(block6num2, "block6num2", row2);
FillRestOfBoard(block6num3, "block6num3", row2);
...
FillRestOfBoard(block4num4,"block4num4", row2);
FillRestOfBoard(block4num5,"block4num5", row2);
FillRestOfBoard(block4num6,"block4num6", row2);
FillRestOfBoard(block5num4,"block5num4", row2);
FillRestOfBoard(block5num5,"block5num5", row2);
FillRestOfBoard(block5num6,"block5num6", row2);
FillRestOfBoard(block6num4,"block6num4", row2);
FillRestOfBoard(block6num5,"block6num5", row2);
FillRestOfBoard(block6num6,"block6num6", row2);
...
FillRestOfBoard(block4num7,"block4num7",row2);
FillRestOfBoard(block4num8,"block4num8",row2);
FillRestOfBoard(block4num9,"block4num9",row2);
FillRestOfBoard(block5num7,"block5num7",row2);
FillRestOfBoard(block5num8,"block5num8",row2);
FillRestOfBoard(block5num9,"block5num9",row2);
FillRestOfBoard(block6num7,"block6num7",row2);
FillRestOfBoard(block6num8,"block6num8",row2);
FillRestOfBoard(block6num9,"block6num9",row2);
...
FillRestOfBoard(block7num1,"block7num1",row2);
FillRestOfBoard(block7num2,"block7num2",row2);
FillRestOfBoard(block7num3,"block7num3",row2);
FillRestOfBoard(block8num1,"block8num1",row2);
FillRestOfBoard(block8num2,"block8num2",row2);
FillRestOfBoard(block8num3,"block8num3",row2);
FillRestOfBoard(block9num1,"block9num1",row2);
FillRestOfBoard(block9num2,"block9num2",row2);
FillRestOfBoard(block9num3,"block9num3",row2);
...
FillRestOfBoard(block7num4,"block7num4",row2);
FillRestOfBoard(block7num5,"block7num5",row2);
FillRestOfBoard(block7num6,"block7num6",row2);
FillRestOfBoard(block8num4,"block8num4",row2);
FillRestOfBoard(block8num5,"block8num5",row2);
FillRestOfBoard(block8num6,"block8num6",row2);
FillRestOfBoard(block9num4,"block9num4",row2);
FillRestOfBoard(block9num5,"block9num5",row2);
FillRestOfBoard(block9num6,"block9num6",row2);
...
FillRestOfBoard(block7num7,"block7num7",row2);
FillRestOfBoard(block7num8,"block7num8",row2);
FillRestOfBoard(block7num9,"block7num9",row2);
FillRestOfBoard(block8num7,"block8num7",row2);
FillRestOfBoard(block8num8,"block8num8",row2);
FillRestOfBoard(block8num9,"block8num9",row2);
FillRestOfBoard(block9num7,"block9num7",row2);
FillRestOfBoard(block9num8,"block9num8",row2);
FillRestOfBoard(block9num9,"block9num9",row2);
